						...
						<Grid key={Math.floor(Math.random() * 100000000000)} container sx={{ paddingBottom: '1em', paddingTop: '0.5em' }} >
							...
							<Grid item xs={4}>
								<Box className={activeArray[0] ? `bet-option-2 bet-option-2-active` : `bet-option-2`} onClick={() => onOptionClick(0)} >
									...
									<Typography variant="body2" style={activeArray[0] ? { fontWeight: 'bold', color: 'black' } : { color: "#5b40f6", fontWeight: 'bold' }}>{game.away_moneyline}</Typography>
								</Box>
							</Grid>
							...
							<Grid item xs={4}>
								<Box className={activeArray[1] ? `bet-option-2 bet-option-2-active` : `bet-option-2`} onClick={() => onOptionClick(1)} >
									...
									<Typography variant="body2" style={activeArray[1] ? { fontWeight: 'bold', color: 'black' } : { color: "#5b40f6", fontWeight: 'bold' }}>{game.draw_moneyline}</Typography>
								</Box>
							</Grid>
							...
							<Grid item xs={4} >
								<Box className={activeArray[2] ? `bet-option-2 bet-option-2-active` : `bet-option-2`} onClick={() => onOptionClick(2)} >
									...
									<Typography variant="body2" style={activeArray[2] ? { fontWeight: 'bold', color: 'black' } : { color: "#5b40f6", fontWeight: 'bold' }}>{game.home_moneyline}</Typography>
								</Box >
							</Grid>
